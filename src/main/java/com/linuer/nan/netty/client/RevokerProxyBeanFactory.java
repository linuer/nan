...
import com.linuer.nan.cluster.engine.LoadBalaceEngine;
...
public class RevokerProxyBeanFactory  implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        LoadBalanceStrategy clusterStrategyService = LoadBalaceEngine.queryClusterStrategy(clusterStrategy);
