...
import com.linuer.nan.netty.codec.RpcDecoderHandler;
import com.linuer.nan.netty.codec.RpcEncoderHandler;
...
public class NettyChannelPoolFactory {
    ...
    public void initChannelPoolFactory(Map<String, List<ProviderService>> providerMap) {
        ...
        Collection<List<ProviderService>> collectionServiceMetaDataList = providerMap.values(); //interface ...HelloService/provider/192.168.43.1|8081|2|100|default
